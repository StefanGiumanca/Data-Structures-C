...
void adaugaMasinaInLista(N** lista, Masina masinaNoua) { // adaugare la finalul listei
	N* nodNou;
...
int getNrUsiMasiniScumpa(N* lista) {
    if(lista) {
...
int main() {
   ...
   int nrUsi = getNrUsiMasiniScumpa(nod);
   printf("Numarul de usi masina scumpa este: %i\n", nrUsi);
